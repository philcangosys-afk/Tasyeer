  ...
  const contactInfo = [
    {
      ...
      titleAr: "الموقع",
      titleEn: "Location",
      contentAr: "منطقة الكاد 1، أبو ظبي، الإمارات العربية المتحدة",
      contentEn: "ICAD1, Abu Dhabi, United Arab Emirates",
      link: "#",
    },
    {
      ...
      titleAr: "الهاتف",
      titleEn: "Phone",
      contentAr: "+971 2 6010 500",
      contentEn: "+971 2 6010 500",
      link: "tel:+97126010500",
    },
    {
      icon: <Mail className="w-8 h-8" />,
      titleAr: "البريد الإلكتروني",
      titleEn: "Email",
      contentAr: "info@tasyeer.ae",
      contentEn: "info@tasyeer.ae",
      link: "mailto:info@tasyeer.ae",
    },
    {
